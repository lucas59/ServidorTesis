...
router.post(
  "/despedirEmpleado",
  haySession,
  usuarioControlador.despedirEmpleado
);
...
router.get(
  "/busquedaEmpleado",
  haySession,
  usuarioControlador.busquedaEmpleado
);

router.get(
  "/exportarAsistencias",
  haySession,
  usuarioControlador.exportarAsistenciascsv
);
...
router.get(
  ...
  haySession,
  usuarioControlador.exportarAsistenciaspdf
);
router.get(
  "/exportarTareaspdf",
  haySession,
  usuarioControlador.exportarTareaspdf
);
...
router.post(
  ...
  haySession,
  usuarioControlador.actualizarConfiguracion
);

router.post("/mensaje", usuarioControlador.enviarMensaje);

router.get("/asistencias", usuarioControlador.getAsistencias);
router.get("/tareas", usuarioControlador.getTareas);
